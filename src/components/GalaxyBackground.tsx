...
export default function GalaxyBackground() {
  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none" style={{ zIndex: 0 }} aria-hidden="true">
      ...
      <span
        className="absolute left-[12%] top-[28%] h-16 w-16 rounded-full bg-cyan-300/10"
        style={{ filter: "blur(22px)" }}
      />
      <span
        className="absolute right-[16%] top-[35%] h-24 w-24 rounded-full bg-violet-400/10"
        style={{ filter: "blur(30px)" }}
      />
      <span
        className="absolute left-[38%] top-[62%] h-14 w-14 rounded-full bg-fuchsia-300/10"
        style={{ filter: "blur(24px)" }}
      />
      <span
        className="absolute right-[38%] top-[18%] h-20 w-20 rounded-full bg-blue-400/10"
